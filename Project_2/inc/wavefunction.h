...
public:
    ...
    static double DerivativePsiManyOfAlpha(const arma::mat &r, const int &nParticles, const double &alpha, const double &omega);
    static double DerivativePsiManyOfBeta(const arma::mat &r, const int &nParticles, const double &beta, const arma::mat &spinMatrix);
